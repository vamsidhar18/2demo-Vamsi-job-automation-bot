...
class VamsiJobAutomationBot {
  ...
  setupExpress() {
    ...
    this.app.get('/status', (req, res) => {
      res.json({
        profile: VamsidharProfile.personal.firstName + ' ' + VamsidharProfile.personal.lastName,
        email: VamsidharProfile.personal.email,
  ...
  start() {
    this.app.listen(this.port, () => {
      this.logger.success(`🚀 Vamsi Job Automation Bot running on port ${this.port}`);
      this.logger.info(`👤 Owner: ${VamsidharProfile.personal.firstName} ${VamsidharProfile.personal.lastName}`);
      this.logger.info(`📧 Email: ${VamsidharProfile.personal.email}`);
